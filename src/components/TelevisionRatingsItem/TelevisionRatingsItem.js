...
import styles from './TelevisionRatingsItem.module.css';

/**
 * A component representing a television ratings item
 */
class TelevisionRatingsItem extends Component {
  /**
   * @class
  ...
  constructor(props) {
    ...
    if (
      ...
      throw new Error('Could not create TelevisionRatingsItem');
    }
   ...
   * Render method
   *
   * @returns {React.Component} JSX TelevisionRatingsItem component
   */
  render() {
    return (
...
export default TelevisionRatingsItem;
