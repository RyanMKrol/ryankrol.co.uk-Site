...
const PORTFOLIO_PAGE_DATA = {
  ...
  portfolioItems: [
    ...
    },
    {
      ...
      portfolioMedia: <FontAwesomeIcon icon={faTerminal} size="6x" />,
    ...
    },
    {
      ...
      portfolioDescription:
        "As a lover of sneakers, there's nothing worse than missing a new release with every supplier sold out. I found that if I didn't check certain shopping apps/sites multiple times a week, I would frequently miss new releases; so I needed something to do this for me. To get around this problem, I created a server app that frequently checks the sites I follow for new releases and then emails myself, and the email list, when there is something new to check out!",
      portfolioMedia: <FontAwesomeIcon icon={faBell} size="6x" />,
      portfolioItemTags: ['swift', 'backend', 'tools'],
    },
    {
